augroup filetype
  ...
  au ColorScheme,BufRead,BufNewFile,BufEnter *.dec,*.dsc,*.fdf,*.sdl setf uefi
  au ColorScheme,BufRead,BufNewFile,BufEnter *.dxs setf c.doxygen
  au ColorScheme,BufRead,BufNewFile,BufEnter *.inf,*.inc,*.dec,*.dsc,*.fdf,*.sdl setlocal commentstring=#\ %s
