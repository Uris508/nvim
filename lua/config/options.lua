...
elseif hr > 14 and hr <= 15 then 
  vim.g.uris_logo = 'chafa %localappdata%/nvim/doom/Gemini_Generated_SpongeBob.png --format symbols --symbols sextant --size 50x60'
elseif hr > 15 and hr <= 16 then
  vim.g.uris_logo = 'chafa %localappdata%/nvim/doom/SpongeBob2.png --format symbols --symbols sextant --size 50x60'
